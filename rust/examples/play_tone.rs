...
const COMMAND_UUID: Uuid = uuid!("00001101-D102-11E1-9B23-00025B00A5A5");
...
async fn main() -> Result<(), Box<dyn Error>> {
    let command = morph_rs::api::consts::MORPH_COMMAND_UUID;
    ...
    let payload: &[u8] = vec![0x0a, 0x66, 0x00, 0x0E, 0x03]
        .as_slice();
