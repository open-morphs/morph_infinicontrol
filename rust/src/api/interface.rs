...
pub mod consts {
    ...
    pub const MORPH_SERVICE_UUID: Uuid = uuid!("00001100-D102-11E1-9B23-00025B00A5A5");
    pub const MORPH_COMMAND_UUID: Uuid = uuid!("00001101-D102-11E1-9B23-00025B00A5A5");
    pub const MORPH_RESPONSE_UUID: Uuid = uuid!("00001102-D102-11E1-9B23-00025B00A5A5");
}
